...
namespace viennacl
{
  namespace linalg
  {
    namespace host_based
    {
      ...
      */
      template< class ScalarType, typename NumericT, unsigned int ALIGNMENT>
      ...
      */
                           ...
                           viennacl::vector_base<ScalarType> & result)
      {
        ...
        vcl_size_t first_element_index_of_block = 0;
        ...
        for(vcl_size_t block_idx = 0; block_idx < num_blocks; ++block_idx)
        {
          ...
          for (IndexT column_entry_index = 0;
                    ...
                    ++column_entry_index)
          {
            vcl_size_t stride_start = first_element_index_of_block + column_entry_index * mat.rows_per_block();
          ...
          first_element_index_of_block += mat.rows_per_block() * current_columns_per_block;
        }
      }
