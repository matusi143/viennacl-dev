...
namespace viennacl
{
    ...
    class sliced_ell_matrix
    {
      public:
        ...
        explicit sliced_ell_matrix() : rows_(0), cols_(0), rows_per_block_(32) {}

        sliced_ell_matrix(size_type num_rows,
                          size_type num_cols,
                          size_type num_rows_per_block_ = 32)
          : rows_(num_rows),
            cols_(num_cols),
            rows_per_block_(num_rows_per_block_) {}

        explicit sliced_ell_matrix(viennacl::context ctx) : rows_(0), cols_(0), rows_per_block_(32)
        {
